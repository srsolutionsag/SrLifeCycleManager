...
namespace srag\Plugins\SrLifeCycleManager\Comparison;

use srag\Plugins\SrLifeCycleManager\Rule\IRule;
use srag\Plugins\SrLifeCycleManager\Dependency\IDependencyPool;
use srag\Plugins\SrLifeCycleManager\Attribute\AttributeFactory;
use srag\Plugins\SrLifeCycleManager\Attribute\IAttribute;
...
class Comparison implements IComparison
{
    ...
    public function __construct(
        ...
        IDependencyPool $pool,
        IRule $rule
    ) {
        $this->attribute_factory = $attribute_factory;
        $this->dependency_pool = $pool;
        $this->rule = $rule;
    }
    ...
    {
        foreach ($lhs_attribute->getComparableTypes() as $lhs_type) {
            foreach ($rhs_attribute->getComparableTypes() as $rhs_type) {
